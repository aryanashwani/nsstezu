    ...
    return b
      ...
      : function (b, d, r) {
          ...
          if ("function" == typeof q) {
            b = q.call(b);
            for (var t = 0; !(q = b.next()).done; )
              k.push(d.call(r, q.value, t++));
          } else
...
$jscomp.findInternal = function (b, k, d) {
  ...
  for (var r = b.length, l = 0; l < r; l++) {
    var q = b[l];
    if (k.call(d, q, l, b)) return { i: l, v: q };
  }
  return { i: -1, v: void 0 };
};
$jscomp.polyfill(
  ...
  function (b) {
    return b
      ...
      : function (b, d) {
          ...
          for (var t = 0; t < q && d < l; ) if (k[d++] != b[t++]) return !1;
          return t >= q;
        };
  },
  "es6",
...
(function () {
  ...
  function t(a) {
    ...
    (function g() {
      ...
      1 < (b += 0.1) || ((a.style.opacity = b), requestAnimationFrame(g));
    })();
  }
  function w(a) {
    var c = [],
  ...
  function G(a) {
    ...
    if (g) {
      ...
      for (var f = 0; f < g.length; f++)
        b.push('"' + g[f].getAttribute("stop-color") + '"');
      b = '"lineargradient": [' + b + "],";
  ...
  Element.prototype.footerReveal = function () {
    function a() {
      !f && b.offsetHeight <= window.outerHeight
        ? ((b.style.zIndex = "-999"),
          (b.style.position = "fixed"),
          (b.style.bottom = "0"),
          (b.style.width = g.offsetWidth + "px"),
          (g.style.marginBottom = b.offsetHeight + "px"))
        : ((b.style.zIndex = ""),
          (b.style.position = ""),
          (b.style.bottom = ""),
          (b.style.width = ""),
  ...
  l(function () {
            ...
            if (c) {
              ...
              d.onload = function () {
                if (120 === (d.naturalWidth || d.width)) {
                  ...
                  (e.style.backgroundImage = 'url("' + d.src + '")'),
                    (e.style.display = "block");
                ...
                p &&
                  u &&
                  (h(document).on("delete.cards", function (a) {
                    m.stopResize();
                    m.stopReplay(
                      a.target.querySelector(".mbr-background-video-wrapper")
                    );
                  }),
                  h(document).on(
                    "changeParameter.cards",
                    function (a, b, c, e) {
                      a = a.target.querySelector(
                        ".mbr-background-video-wrapper"
                      );
                      if ("bg" === b)
                        switch (e) {
                          case "type":
              ...
              if (c) {
                ...
                b.element.style.marginLeft =
                  "-" + (b.element.scrollWidth - n.scrollWidth) / 2 + "px";
        ...
        h(document).on("changeParameter.cards", function (a, b, e, d) {
          if ("bg" === b)
            switch (
              ...
              (b.style.position = ""),
              h(a.target).find(".mbr-background-video-preview").remove(),
              h(a.target).find(".mbr-background-video").remove(),
              h(a.target).find(".mbr-background-video-wrapper").remove(),
              h(a.target).find(".mbr-fallback-image").remove(),
              d)
            ) {
              case "type":
    ...
    window.addEventListener("scroll", function () {
      ...
      if (m) {
        ...
        b
          ? c != m.fixed &&
            (l
              ? ((m.fixed = c), m.elm.classList.toggle("is-fixed"))
              : (e = setTimeout(function () {
                  m.fixed = c;
                  m.elm.classList.toggle("is-fixed");
                }, 40)))
          : ((m.fixed = !1), m.elm.classList.remove("is-fixed"));
      }
    });
    if (u)
    ...
    window.smartresize(function () {
      document.querySelectorAll(".mbr-embedded-video").forEach(function (a) {
        a.style.height =
          (
            (r(a) * parseInt(a.getAttribute("height") || 315)) /
    ...
    h(document)
      ...
      .on("changeParameter.cards", function (a, b, d) {
        "testimonialsSlides" === b &&
          0 == h(a.target).find(".carousel-item.active").length &&
          A(a.target);
      });
  else
    "undefined" === typeof window.initTestimonialsPlugin &&
